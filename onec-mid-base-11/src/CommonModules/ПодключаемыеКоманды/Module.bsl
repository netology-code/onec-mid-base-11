...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	//Доработка 30.10.24
	Если ЕстьПараметрыОбъекта = Истина Тогда	
			Если Форма.ИмяФормы = "Документ.ЗаказПокупателя.Форма.ФормаДокумента" Или
				...
				ГруппаШапкаПраво = Форма.Элементы.Найти("ГруппаШапкаПраво");
				НовыйРеквизит = Форма.Элементы.Вставить("Нето_КонтактноеЛицо", Тип("ПолеФормы"), ГруппаШапкаПраво); 
			ИначеЕсли Форма.ИмяФормы = "Документ.ОплатаОтПокупателя.Форма.ФормаДокумента" Тогда
				...
				НовыйРеквизит = Форма.Элементы.Вставить("Нето_КонтактноеЛицо", Тип("ПолеФормы"),, СледующийЭлемент);
			...
			НовыйРеквизит.Заголовок = "Контактное лицо";
			НовыйРеквизит.ПутьКДанным = "Объект.Нето_КонтактноеЛицо";
		КонецЕсли;
	//конец
