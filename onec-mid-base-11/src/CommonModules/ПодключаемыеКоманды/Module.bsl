...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	//Сморгун А.В. Доработка формы по заданию «Внесение изменений в конфигурацию на поддержке»
	ДЗ_ДоработкаФормДокументов.ДополнитьФорму(Форма);
	//Конец Доработки формы
