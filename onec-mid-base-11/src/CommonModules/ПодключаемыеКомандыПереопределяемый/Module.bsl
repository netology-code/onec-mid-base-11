...
//++ 03.02.24 Доработки в рамках ДЗ №2 модуля "Совместная разработка (EDT)"

//Определение места вставки поля "Контактное лицо" на форму
Процедура ДобавлениеЭлементовФормыДокументов(Форма) Экспорт 
	
	ИмяФормы = Форма.ИмяФормы;
	
	Если ИмяФормы = "Документ.ЗаказПокупателя.Форма.ФормаДокумента" Тогда
		ДобавитьПолеКонтктноеЛицоВГруппаШапкаПраво(Форма);
	...
	ИначеЕсли ИмяФормы = "Документ.ОплатаОтПокупателя.Форма.ФормаДокумента" Тогда
		ДобавитьПолеКонтктноеЛицоНаФормуПередСуммаДокумента(Форма);    
...
// Вставка поля в группу "ШапкаПраво"

Процедура ДобавитьПолеКонтктноеЛицоВГруппаШапкаПраво(Форма)
	
	НоваяСвязь = Новый СвязьПараметраВыбора("Отбор.Владелец", "Объект.Контрагент");
	НовыйМассив = Новый Массив;
	НовыйМассив.Добавить(НоваяСвязь);
	МассивПараметровВыбора = Новый ФиксированныйМассив(НовыйМассив);
	...
	НовыйЭлемент.СвязиПараметровВыбора = МассивПараметровВыбора;	

	
КонецПроцедуры     

//Вставка поля без группы

Процедура ДобавитьПолеКонтктноеЛицоНаФормуПередСуммаДокумента(Форма)
...
//-- 03.02.24 Конец доработок в рамках ДЗ №2 модуля "Совместная разработка (EDT)"
