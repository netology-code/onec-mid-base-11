...
Процедура РассчитатьСуммуСтроки(ТекущиеДанные)
	...
	//+Попов Сергей Александрович, 19.111.24
	//Изменяем расчет суммы с учетом скидки
	//ТекущиеДанные.Сумма = ТекущиеДанные.Цена * ТекущиеДанные.Количество;
	Скидка = ТекущиеДанные.Цена * ТекущиеДанные.Количество  * (Объект.Дор_СогласованнаяСкидка / 100);
